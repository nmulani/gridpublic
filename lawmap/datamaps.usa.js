(function() {
  ...
  function addStyleBlock() {
    if ( d3.select('.datamaps-style-block').empty() ) {
      ...
      .html('.datamap path.datamaps-graticule { fill: none; stroke: #777; stroke-width: 0.5px; stroke-opacity: .5; pointer-events: none; } .datamap .labels {pointer-events: none;} .datamap path {stroke: #FFFFFF; stroke-width: 1px;} .datamaps-legend dt, .datamaps-legend dd { float: left; margin: 0 5px 0 0;} .datamaps-legend dd {width: 20px; margin-right: 6px; border-radius: 0.1px;} .datamaps-legend {padding-bottom: 20px; z-index: 1001; position: absolute; left: 4px; font-size: 12px; font-family: "Computer Modern", Helvetica, Arial, sans-serif;} .datamaps-hoverover {display: none; font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; } .hoverinfo {padding: 4px; border-radius: 1px; background-color: #FFF; box-shadow: 1px 1px 5px #CCC; font-family: "Computer Modern"; font-size: 12px; border: 1px solid #CCC; } .hoverinfo hr {border:1px dotted #CCC; }');
    }
  }
  ...
  function addLegend(layer, data, options) {
    ...
    for ( var fillKey in this.options.fills ) {
      ...
      html += '<p><dt>' + label + '</dt>';
      html += '<dd style="background-color:' +  this.options.fills[fillKey] + ';border-width:0.5;border-style:solid;">&nbsp;</dd></p>';
    }
    html += '</dl>';
